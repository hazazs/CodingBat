public class CodingBat {
    ...
    public boolean unlucky1(int[] nums) {
        boolean firstUnlucky = false;
        boolean secondUnlucky = nums.length > 2 && nums[1] == 1 && nums[2] == 3;
        boolean secondLastUnlucky = false;
        if (nums.length > 1) {
            firstUnlucky = nums[0] == 1 && nums[1] == 3;
            secondLastUnlucky = nums[nums.length - 2] == 1 && nums[nums.length - 1] == 3;
        }
